...
export GAZEBO_MODEL_PATH=$GAZEBO_MODEL_PATH:$SMART_ROOT_ACE/repos/DataRepository/gazebo/models
export GAZEBO_PLUGIN_PATH=$GAZEBO_PLUGIN_PATH:$SMART_ROOT_ACE/lib
